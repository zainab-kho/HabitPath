...
export const HABIT_ICONS: Record<string, any> = {
  ...
  'video-game': require('@/assets/icons/habits/entertainment/video-game.png'),
  'nintendo-switch': require('@/assets/icons/habits/entertainment/nintendo-switch.png'),
...
export const ICON_CATEGORIES: Record<string, HabitIcon[]> = {
  ...
  Lifestyle: [
    ...
    { name: 'video-game', file: HABIT_ICONS['video-game']},
    { name: 'nintendo-switch', file: HABIT_ICONS['nintendo-switch']},
...
export const SYSTEM_ICONS = {
  ...
  lists: require('@/assets/icons/system/lists.png'),
  ...
  link: require('@/assets/icons/system/link.png'),
};
